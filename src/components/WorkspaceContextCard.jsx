...
export default function WorkspaceContextCard({ settings }) {
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <div className="space-y-0.5">
            ...
            <p className="text-xs font-semibold text-slate-200">{activePage.label}</p>
          </div>
        ...
        <div className="pt-2 border-t border-white/5 space-y-2">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[9px] text-slate-400 uppercase tracking-tight">Token Status: Using Global Facebook Settings</span>
          </div>
