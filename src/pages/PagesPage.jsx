        ...
        <div className="rounded-2xl border border-white/5 bg-slate-900/40 p-5 shadow-sm">
          ...
          {selectedPage ? (
            <div className="space-y-4">
              ...
              <label className="block">
                <span className="mb-2 block text-[10px] font-bold uppercase tracking-wider text-slate-500">เป้าหมายของเพจ</span>
                <textarea
                  ...
                  placeholder="สรุปบทบาทหลักของเพจนี้แบบสั้น ๆ"
                />
              </label>
                ...
                <div className="rounded-2xl border border-white/5 bg-slate-950/40 p-4">
                  ...
                  <p className="mt-1 text-xs text-slate-400">
                    {selectedPage.id === "default"
                      ? "ระบบจะใช้เพจนี้เป็น fallback เมื่อยังหา page context ที่ต้องการไม่เจอ"
          ...
          <div className="rounded-2xl border border-white/5 bg-slate-900/40 p-5 shadow-sm">
            ...
            <div className="space-y-4">
              <textarea
                ...
                placeholder="แนวทางการเขียน เช่น สั้น ชัด ให้ความรู้ หรือเป็นกันเอง"
              />
              <textarea
                value={selectedPage.imageDirection || ""}
                onChange={(event) => updateWorkspacePage(selectedPage.id, { imageDirection: event.target.value })}
                className="h-24 w-full rounded-xl border border-white/10 bg-slate-950/50 px-4 py-3 text-sm outline-none focus:border-emerald-400"
                placeholder="แนว prompt ภาพ เช่น มุมกล้อง สไตล์ภาพ โทนสี หรือองค์ประกอบหลัก"
              />
              ...
              <textarea
                ...
                className="h-24 w-full rounded-xl border border-white/10 bg-slate-950/50 px-4 py-3 text-sm outline-none focus:border-emerald-400"
                placeholder="Content pillars (แยกบรรทัดหรือคอมม่า)"
              />
              <textarea
                ...
                placeholder="Avoid list หรือคำ/แนวที่ไม่ควรใช้"
              />
              <input
      ...
      <div className="rounded-2xl border border-white/5 bg-slate-900/40 p-5 shadow-sm">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-1 text-xs text-slate-400">
              ระบบจะเก็บข้อมูลไว้ในเครื่องทันที และ sync ข้อมูลเพจพื้นฐานขึ้น Supabase เท่าที่โครงสร้างปัจจุบันรองรับ
            </p>
          </div>
          <ActionButton
